...
// cublas handle
extern hipblasHandle_t cublasHandle;

// cuda timing, times are in milliseconds
extern hipEvent_t start, stop;

extern hipblasStatus_t aimsSetVector(
      const ssize_t dim,
      const int elemSize,
      const void* from,
      const int ld1,
...
extern hipblasStatus_t aimsSetMatrix(
      const ssize_t rows,
      const ssize_t cols,
      const int elemSize,
      const void* from,
...
extern hipblasStatus_t aimsGetVector(
      const ssize_t dim,
      const int elemSize,
      const void* from,
      const int ld1,
...
extern hipblasStatus_t aimsGetMatrix(
      const ssize_t rows,
      const ssize_t cols,
      const int elemSize,
      const void* from,
